...
public class BackgroundRenderer {
   ...
   * {@link SampleRender.Renderer#onSurfaceCreated()}.
   */
  ...
  /**
   * Sets whether to use depth for occlusion. This reloads the shader code with new
   * {@code #define}s, and must be called on the GL thread.
   */
